...
(function () {
  ...
  var app = {
    beginAppRun: function beginAppRun(beginType) {
      dataSearch.gsrsearch = $('form input').val();
      this.wikiAjax(beginType);
    },
    wikiAjax: function wikiAjax(searchType) {
      $.ajax({
    ...
    clearHtml: function clearHtml(el) {
      $(el).html('');
    },
    searchResults: function searchResults(obj) {
